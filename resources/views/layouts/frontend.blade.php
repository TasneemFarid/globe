                        ...
                        <div class="header-logo">
                            ...
                            <a href="home-style-one.html">
                                <img class="td-retina-data img-responsive"
                                    src="{{ asset('backend_asset/images/globe_logo.svg') }}" alt="">
                            </a>
                        </div>
                    </div>
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        @foreach ($categories as $category)
                            <li class="active">
                                <a href="" class="category01">{{ strtoupper($category->category_name) }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="footer-box">
                        ...
                        <div class="box-item wow fadeIn" data-wow-duration="2s">
                            <div class="img-thumb">
                                <a href="#" rel="bookmark"><img class="entry-thumb"
                                        src="{{ asset('frontend_asset/images/popular_news_01.jpg') }}" alt=""
                        ...
                        <div class="box-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                            <div class="img-thumb">
                                <a href="#" rel="bookmark"><img class="entry-thumb"
                                        src="{{ asset('frontend_asset/images/popular_news_02.jpg') }}" alt=""
                                        height="80" width="100"></a>
                            </div>
                            <div class="item-details">
                        ...
                        <div class="box-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s">
                            <div class="img-thumb">
                                <a href="#" rel="bookmark"><img class="entry-thumb"
                                        src="{{ asset('frontend_asset/images/popular_news_03.jpg') }}" alt=""
                                        height="80" width="100"></a>
                            </div>
                            <div class="item-details">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="footer-box footer-logo-address">
                        <!-- address  -->
                        <img src="{{ asset('frontend_asset/images/footer-logo.png') }}" class="img-responsive"
                            alt="">
                        <address>
