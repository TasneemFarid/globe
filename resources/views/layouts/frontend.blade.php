...
<!-- Mirrored from news365htmllatest.bdtask.com/Demo/DemoNews365/home-style-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Mar 2023 15:14:21 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{asset('backend_asset/images/logo_icon.png')}}" />
    ...
    <!-- Scrollbar css -->
    <link rel="stylesheet" type="text/css" href="{{asset('frontend_asset/css/jquery.mCustomScrollbar.css')}}" />
    <!-- Owl Carousel css -->
    <link rel="stylesheet" type="text/css" href="{{asset('frontend_asset/owl-carousel/owl.carousel.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('frontend_asset/owl-carousel/owl.theme.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('frontend_asset/owl-carousel/owl.transitions.css')}}" />
    <!-- youtube css -->
    <link rel="stylesheet" type="text/css" href="{{asset('frontend_asset/css/RYPP.css')}}" />
    <!-- jquery-ui css -->
    ...
    <!-- fonts css -->
    <link rel="stylesheet" href="{{asset('frontend_asset/font-awesome/css/font-awesome.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('frontend_asset/css/Pe-icon-7-stroke.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('frontend_asset/css/flaticon.css')}}" />
    <!-- custom css -->
...
<body>
                    ...
                    <div class="col-12">
                        <div class="header-logo">
                            ...
                            <a href="home-style-one.html">
                                <img class="td-retina-data img-responsive" src="{{asset('backend_asset/images/globe_logo.svg')}}" alt="">
                            </a>
                        </div>
                    </div>
                    <div class="col-xs-8 col-md-8 col-sm-8 hidden-xs">
                        <div class="header-banner">
                            <a href="#"><img class="td-retina img-responsive" src="{{asset('frontend_asset/images/top-bannner.jpg')}}')}}" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <nav class="navbar">
                <div class="collapse navbar-collapse m-auto">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="home-style-one.html" class="category01">{{strtoupper($category->category_name)}}</a></li>
                        @endforeach
                        <li class="active"><a href="home-style-one.html" class="category01">OTHER</a></li>
                        {{-- <li class="dropdown">
    ...
    <!-- footer Area ============================================ -->
                    ...
                    <div class="col-sm-4">
                        <div class="footer-box">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="2s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{asset('frontend_asset/images/popular_news_01.jpg')}}" alt="" height="80" width="100"></a>
                                </div>
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{asset('frontend_asset/images/popular_news_02.jpg')}}" alt="" height="80" width="100"></a>
                                </div>
                                <div class="item-details">
                            ...
                            <div class="box-item wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s">
                                <div class="img-thumb">
                                    <a href="#" rel="bookmark"><img class="entry-thumb" src="{{asset('frontend_asset/images/popular_news_03.jpg')}}" alt="" height="80" width="100"></a>
                                </div>
                                <div class="item-details">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="footer-box footer-logo-address">
                            <!-- address  -->
                            <img src="{{asset('frontend_asset/images/footer-logo.png')}}" class="img-responsive" alt="">
                            <address>
        ...
        <script type="text/javascript" src="{{asset('frontend_asset/js/bootstrap.min.js')}}"></script>
        <!-- Metis Menu Plugin JavaScript -->
        <script type="text/javascript" src="{{asset('frontend_asset/js/metisMenu.min.js')}}"></script>
        <!-- Scrollbar js -->
        <script type="text/javascript" src="{{asset('frontend_asset/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
        <!-- animate js -->
        <script type="text/javascript" src="{{asset('frontend_asset/js/wow.min.js')}}"></script>
        <!-- Newstricker js -->
        <script type="text/javascript" src="{{asset('frontend_asset/js/jquery.newsTicker.js')}}"></script>
        <!--  classify JavaScript -->
        <script type="text/javascript" src="{{asset('frontend_asset/js/classie.js')}}"></script>
        <!-- owl carousel js -->
        <script type="text/javascript" src="{{asset('frontend_asset/owl-carousel/owl.carousel.js')}}"></script>
        <!-- youtube js -->
        <script type="text/javascript" src="{{asset('frontend_asset/js/RYPP.js')}}"></script>
        <!-- jquery ui js -->
        <script type="text/javascript" src="{{asset('frontend_asset/js/jquery-ui.js')}}"></script>
        <!-- form -->
        <script type="text/javascript" src="{{asset('frontend_asset/js/form-classie.js')}}"></script>
        <!-- custom js -->
        <script type="text/javascript" src="{{asset('frontend_asset/js/custom.js')}}"></script>
    </body>
    
    
    <!-- Mirrored from news365htmllatest.bdtask.com/Demo/DemoNews365/home-style-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Mar 2023 15:18:55 GMT -->
    </html>
